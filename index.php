        ...
        <div class="rows" style="background-color: #EEEEF2;">
            <div class="container paddingp">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col-xxs-12">
                    <div class="thumbnail">
                        <img src="images/housing.jpg" alt="...">
                        <div class="caption">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col-xxs-12">
                    <div class="thumbnail">
                        <img src="images/bracket.jpg" alt="...">
                        <div class="caption">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col-xxs-12">
                    <div class="thumbnail">
                        <img src="images/accesssory.jpg" alt="...">
                        <div class="caption">
        ...
        <section class="cta">
            <div class="cta-content">
                <div class="container">
                    ...
                    <a href="#" class="btn btn-primary btn-xl page-scroll">download</a>
                </div>
            </div>
